...
function updateGraph(step) {
    if(step === 0) {
        ...
        d3.selectAll(".country.group2 circle").classed("hidden", true);
        d3.selectAll(".country.group3 circle").classed("hidden", true);
        d3.selectAll(".country.group4 circle").classed("hidden", true);
        d3.selectAll(".country.group2 .countryNameLabel").classed("hidden", true);
    }
    else if(step === 1) {
        ...
        d3.selectAll(".country.group4 circle").classed("hidden", false);
        d3.selectAll(".country.group4 .countryNameLabel.hidden").classed("hidden", false);
    }
}
